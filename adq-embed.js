  ...
  function render(animate) {
    ...
    setTimeout(function () {
      ...
      requestAnimationFrame(function () { requestAnimationFrame(function () {
        ...
        setTimeout(function () { body.classList.remove('anim-in'); _animBusy = false; if (body.scrollTop) body.scrollTop = 0; }, 200);   // final enforcement — iOS momentum/anchoring can re-scroll mid-animation
      }); });
    }, 130);
  }
