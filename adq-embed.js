...
(function () {
  ...
  function render(animate) {
    if (!animate || ov.hidden) { renderInner(); return; }
    if (_animBusy) { renderInner(); return; }
    _animBusy = true;
