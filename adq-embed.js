  ...
  function renderInner() {
    ...
    if (wh) {
      ...
      wh.addEventListener('click', function (ev) {
        ...
        if (!t) return;
        var top = (parseInt(t.getAttribute('data-wv'), 10) - wMin) * IH;
        if (wh.scrollTo) wh.scrollTo({ top: top, behavior: 'smooth' }); else wh.scrollTop = top;
      });
    }
