...
(function () {
  ...
  var QS = [
    ...
    { key: 'interest', type: 'multi', title: 'Why do you want us to run your dating apps for you?', desc: 'Select all that apply', opts: ['I want a team to run my dating apps and put quality dates directly on my calendar', "I'm tired of putting in so much effort to get dates.", 'I want a proven system that actually get results.', "I've seen your client results & transformations", 'I want to add an extra funnel for landing high quality dates.'] },
  ...
  function render(animate) {
    if (!animate || ov.hidden) { renderInner(); fitAlign(); body.scrollTop = 0; return; }
    if (_animBusy) { renderInner(); fitAlign(); body.scrollTop = 0; return; }
    _animBusy = true;
