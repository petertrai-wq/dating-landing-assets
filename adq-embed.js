...
(function () {
  ...
  function invqPriceShown() { return false; }   // price disclosure fully RETIRED (Peter 2026-07-31 "remove the show price from the original form"): the 100-150k price line was the last live arm and it suppressed bookings ~2x + confounded ST10 (150k+ arm already killed 7/30, 17.6% vs 52.4% Yes). Both forms now match: no pricing before the scheduler. Keep the function — invq beacons + this history stay greppable.
