...
(function () {
  ...
  var STEPS = [
    ...
    { key: 'support', type: 'multi',
      ...
      opts: ['A profile that matches the lifestyle I built', 'Photos that look like my best self', 'Wardrobe & style', 'Knowing my exact type and targeting it', 'Date planning & logistics', 'First date strategy', 'Texting help', 'Getting into a long-term relationship', 'Traveling with a goal of meeting the right woman', 'All of the above (most popular)'],
      card: qq('"I don\'t have trouble with women. I just don\'t want to spend the time."', 'A', 'Anthony P.', 'Physician, London', 'tw-anthony.jpg') },
    ...
    { key: 'income', type: 'radio',
      ...
      card: qq('"I\'d rather just pay somebody."', 'T', 'Tony B.', 'Info Business Owner, Austin', 'tw-tony.jpg') },
